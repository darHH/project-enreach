...
import { 
  Box, Container, Paper, Typography, Fade, Grow,
                ...
                <Box sx={{ 
                  ...
                  >
                    <Box sx={{ display: 'flex' }}>
                      ...
                      >
                        <Box sx={{ height: '120px', display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 3, p: 2 }}>
                          <img
                            src="/city u.svg"
                            alt="CityU Department of English"
                            style={{ maxWidth: '100%', maxHeight: '100%', objectFit: 'contain', filter: 'drop-shadow(0 4px 6px rgba(0,0,0,0.1))' }}
                          />
                        </Box>
                        ...
                        >
                          ...
                          >
                            <img
                              src={sponsor.img}
                              alt={sponsor.name}
                              style={{ maxWidth: '85%', maxHeight: '85px', objectFit: 'contain', filter: 'grayscale(20%)', transition: 'all 0.3s ease' }}
                              onMouseOver={(e) => {
                      ...
                      >
                        ...
                        >
                          <img
                            src={org.img}
                            alt={org.name}
                            style={{ maxWidth: '90%', maxHeight: '90px', objectFit: 'contain', transition: 'all 0.3s ease' }}
                            onMouseOver={(e) => { e.currentTarget.style.transform = 'scale(1.08)'; }}
                            onMouseOut={(e) => { e.currentTarget.style.transform = 'scale(1)'; }}
                          />
                        </Box>
                        <Typography variant="subtitle2" align="center" fontWeight="bold" sx={{ fontSize: '0.85rem', lineHeight: 1.4 }}>
                          {org.name}
                        </Typography>
                        <Box
                          sx={{
                            ...
                            px: 2,
                            py: 0.5,
                            bgcolor: org.type === 'Schools' ? '#e3f2fd' : org.type === 'NGOs' ? '#f1f8e9' : '#fff8e1',
                            borderRadius: '12px',
                            fontSize: '0.75rem',
                            fontWeight: 500,
                          }}
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <Box>
                      <Typography variant="subtitle1" fontWeight="bold" color="#006e34">Phone:</Typography>
                      <Typography variant="body1">(852) 9198 3989 - Quincy Tse</Typography>
                    </Box>
                  </Box>
                  ...
                  >
                    ...
                    <Box>
                      <Typography variant="subtitle1" fontWeight="bold" color="#006e34">Email:</Typography>
                      <Typography variant="body1">
                        <a
                          href="mailto:info@reach.org.hk"
                          style={{ color: '#006e34', textDecoration: 'none', borderBottom: '1px dotted #006e34' }}
                        >
                          info@reach.org.hk
                        </a>
                      </Typography>
                ...
                <Box sx={{ mt: 3 }}>
                  ...
                  >
                    ...
                    <Box>
                      <Typography variant="subtitle1" fontWeight="bold" color="#006e34">Address:</Typography>
                      <Typography variant="body1">Room 902, 9/F, 168 Queen&apos;s Road Central</Typography>
                      <Typography variant="body1">Central, Hong Kong</Typography>
                    </Box>
                  </Box>
                </Box>
